...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-04-04 01:49`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/4d550eea-c839-419d-90a2-bd5160adef16.git
$ cd 4d550eea-c839-419d-90a2-bd5160adef16
```
